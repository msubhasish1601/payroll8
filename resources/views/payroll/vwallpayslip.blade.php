...
<head>
    <title>{{ config('app.name', 'Laravel') }} - Payslip</title>
        ...
        <table class="comp-det" style="width:100%;">
            <tr>
                ...
                <td style="text-align:center;" width="65%">
                    ...
                    <div class="pay-head">
                        <h2>{{$record['company_rs']->company_name}}</h2>
            ...
            <tbody>
                <tr>
                    <td colspan="2" width="33.33%"><span>Employee Code :</span><br>
                        {{$record['payroll_rs'][0]->old_emp_code}}</td>
                    <td colspan="2" width="33.33%"><span>Employee Name :</span><br>
                        {{$record['payroll_rs'][0]->emp_name}}</td>
                    <td colspan="2" width="33.33%"><span>Department :</span><br>
                        {{$record['payroll_rs'][0]->emp_department}}</td>
                </tr>

                <tr>
                    <td colspan="2"><span>Designation :</span><br> {{$record['payroll_rs'][0]->emp_designation}}</td>
                    <td colspan="2">
						@if($record['payroll_rs'][0]->emp_uan_no!='' && $record['payroll_rs'][0]->emp_uan_no!='0')
						<span>UAN No. :</span><br> {{$record['payroll_rs'][0]->emp_uan_no}}
						@endif
					</td>
        ...
        <table border="1" class="emp-det" style="width:100%;border-collapse:collapse;border-color:#cacaca;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Basic Pay</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_basic_pay}}</td>
                    <td>PROF TAX</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_prof_tax}}</td>
                </tr>
                <tr>
                    <!-- <td>DA</td>
                    ...
                    <td>PF</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_pf}}</td>
                </tr>
                <tr>
                    <!-- <td>VDA</td>
                ...
                <tr>
                    ...
                    <td>TIFF ALW.</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_tiff_alw}}</td>
                    <td>I TAX</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_i_tax}}</td>
                </tr>
                <tr>
                    <!-- <td>OTH ALW</td>
						<td style="text-align:right;">@if(isset($actual_payroll->emp_actual_others_alw)){{$actual_payroll->emp_actual_others_alw}}@endif</td> -->
                    <td>OTH ALW</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_others_alw}}</td>
                    <td>INSU PERM</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_insu_prem}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>MEDICAL</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_medical}}</td>
                    <td>ESI</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_esi}}</td>
                </tr>
                <tr>
                    ...
                    <td>MISC ALW</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_misc_alw}}</td>
                    <td>ADV</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_adv}}</td>
                </tr>
                <tr>
                    ...
                    <td>OVER TIME</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_over_time}}</td>
                    <td>HRD</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_hrd}}</td>
                </tr>
                <tr>
                    ...
                    <td>BONUS</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_bouns}}</td>
                    <td>CO-OP</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_co_op}}</td>
                </tr>
                <tr>
                    ...
                    <td>LEAVE ENC</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_leave_inc}}</td>
                    <td>FURNITURE</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_furniture}}</td>
                </tr>
                <tr>
                    ...
                    <td>HTA</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_hta}}</td>
                    <td>MISE DED</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_misc_ded}}</td>
                </tr>
                ...
                <tr>
                    ...
                    <td rowspan="3" style="text-align:right;">{{$record['payroll_rs'][0]->other_addition}}</td>

                    <td>Employer PF Contribution</td>
                    <td style="text-align:right;">
                        @if(isset($record['payroll_rs'][0]->emp_pf_employer)){{$record['payroll_rs'][0]->emp_pf_employer}}@else
                        0 @endif</td>
                ...
                <tr>
                    ...
                    <td>TDS</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_tds_ded}}</td>
                ...
                <tr>
                    ...
                    <td>Others</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->other_deduction}}</td>
                ...
                <tr class="total">
                    ...
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_gross_salary}}</td>
                    <td>Total Deductions</td>
                    <td style="text-align:right;">{{$record['payroll_rs'][0]->emp_total_deduction}}</td>
                </tr>
...
//echo $result . "Rupees  " . $points . " Paise"; ?>
                ...
                <tr>
                    <td style="font-weight:500;" colspan="2"><b>No. of pay in days:
                            <?php echo $no_of_pay_days = $record['current_month_days'] - $record['payroll_rs'][0]->emp_absent_days; ?>
                        </b>

                        <p style="margin: 0">E. &amp; O.E. This is a computer generated payslip and does not need a
                            signature</p>
                    </td>
                    <td style="font-weight:600;text-align:right;" colspan="2"><span style="float: left;">Net Salary
                            :</span> <img src="{{ asset('theme/payslip-img/rupee.png') }}" alt=""
                            style="width: 8px;vertical-align: middle;"> {{$record['payroll_rs'][0]->emp_net_salary}}<br>
