...
?>
                                    ...
                                    <li>
                                        <p><span>Leave type:</span> {{$value->leave_type_name}} </p>
                                        <p><span>Status:</span> {{$value->status}} </p>
                                        <p><span>Date of Application:</span>
                                            {{date('d-m-Y',strtotime($value->date_of_apply))}} </p>
                                        <p><span>No of Leave:</span> {{$value->no_of_leave}} </p>
                                        <p><span>Duration:</span> {{date('d-m-Y',strtotime($value->from_date))}} to
                                            {{date('d-m-Y',strtotime($value->to_date))}} </p>
                                        <p><span>Remarks:</span> {{$value->status_remarks}} </p>
                                    </li>
