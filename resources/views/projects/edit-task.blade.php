        ...
        <div class="tab-content">
            <div class="animated fadeIn">
                <div class="main-card task-form">
                    <div class="card">
                        <div class="aply-lv">
                            <h5 class="card-title pull-left">Edit Task Information - {{$project->name}}</h5>
                            <a class="btn btn-default pull-right"
                                href="{{url('projects/edit-project/'.$project_id)}}">Back</a>
                        </div>
                        <div class="card-body card-block">

                            <form action="{{ url('projects/update-task') }}" method="post" enctype="multipart/form-data"  class="form-horizontal">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-12 col-md-4" style="padding-left: 4%;">
                                            <div class="form-group">
                                                ...
                                                <select name="employee_id" id="employee_id"
                                                    ...
                                                    <option value="{{$emp->emp_code}}" @if(isset($TaskData->employee_id) &&
                                                    $TaskData->employee_id==$emp->
                                        ...
                                        <div class="col-12 col-md-3" style="padding-left: 0%;">
                                            <div class="form-group">
                                                ...
                                                <select name="assigned_by" id="assigned_by"
                                                    ...
                                                    @foreach ($emplist as $emp)
                                                    <option value="{{$emp->emp_code}}" @if(isset($TaskData->assigned_by) &&
                                                    $TaskData->assigned_by==$emp->
                                                        emp_code ) selected @endif>
                                                        {{($emp->emp_fname . ' '. $emp->emp_mname.' '.$emp->emp_lname)}}
                                                    </option>
                                                    @endforeach
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="task_description"
                                                    name="task_description" class="form-control" value="{{$TaskData->task_description}}" required>
                                            </div>
                                        </div>
