...
<div class="user-head">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				<div class="prof-name">
					<h4><?php echo (isset($employee->emp_fname) ? $employee->emp_fname : '') . " " . (isset($employee->emp_mname) ? $employee->emp_mname : '') . " " . (isset($employee->emp_lname) ? $employee->emp_lname : ''); ?></h4>
			...
			<div class="col-md-4">
				<div class="prof-img">
					...
					<img src="{{ url('/') }}/{{ $employee->emp_image }}" alt="">
				    <?php } else {?>
			...
			<div class="col-md-8">
				<div class="personal">
					...
					<div class="row per-body">
						...
						<div class="col-md-8"><p class="ans"><?php echo $employee->old_emp_code; ?></p></div>
		...
		<div class="col-md-4">
			<div class="pay-details">
				...
				<ul>
					...
					<li>UAN No.: <span><?php echo $employee->emp_uan_no ?? ''; ?></span></li>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="border:none;">
      ...
      <div class="modal-body" style="margin: 15px;">
        <form action="{{ url('employee-corner/change-password') }}" method="post" enctype="">
