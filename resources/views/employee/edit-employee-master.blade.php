        ...
        <div class="row">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form name="basicform" id="basicform" method="post"
                                    action="{{ url('update-employee') }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_code;}?>"
                                                        name="emp_code" class="form-control" readonly="1">

                                                </div>
                                                <div class="col-md-3">
                                                    <label>Employee Code </label>
                                                    <input type="text"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->old_emp_code;}?>"
                                                        name="old_emp_code" class="form-control" required>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="salutations" id="salutations">
                                                        ...
                                                        <option value="{{ $value}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->salutation == $value) {echo 'selected';}}?>>
                                                            {{ $value}}</option>
                                                        @endforeach
                                                        @endif
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="emp_fname"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_fname;}?>"
                                                        class="form-control" id="fname" required>
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Middle Name</label>
                                                    <input type="text" name="emp_mid_name"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_mname;}?>"
                                                        class="form-control" id="fname">
                                                </div>
                                                <div class="col-md-3">
                                                    <label>Last Name </label>
                                                    <input type="text" name="emp_lname"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_lname;}?>"
            ...
            <div class="row form-group"> -->
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="emp_father_name" id="emp_father_name"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_father_name;}?>"
			  	...
			  	<label>Present City Class <span>(*)</span></label>
	                ...
	                <input type="hidden" name="emp_home_town" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_home_town;}?>" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="emp_nearest_railway"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nearest_railway;}?>"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_caste">
                                                        ...
                                                        <option value="{{$castname->cast_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_caste == $castname->cast_name) {echo 'selected';}}?>>
                                                            {{$castname->cast_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_sub_caste"
                                                        ...
                                                        <option value="{{$subcastname->sub_cast_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_sub_caste == $subcastname->sub_cast_name) {echo 'selected';}}?>>
                                                            {{$subcastname->sub_cast_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_religion">
                                                        ...
                                                        <option value="{{$rel->religion_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_religion == $rel->religion_name) {echo 'selected';}}?>>
                                                    ...
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            ...
                                                            <input type="radio" class="form-check-input" value="Yes"
                                                                <?php if (request()->get('q') != '') {if ($employee_rs[0]->marital_status == 'Yes') {echo 'checked';}}?>
                                                                name="marital_status" onclick="showHideDiv()"
                                                                id="marital_status">Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check-inline">
                                                        <label class="form-check-label">
                                                            <input type="radio" class="form-check-input" value="No"
                                                                <?php if (request()->get('q') != '') {if ($employee_rs[0]->marital_status == 'No') {echo 'checked';}} else {echo 'checked';}?>
                                                                name="marital_status" onclick="showHideDiv()">No
                                                    </div>

                                                </div>
                                                <div class="col-md-3" id="marriage_date">
                                                    <label>Date</span></label>
                                                    <input type="date" name="marital_date"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->marital_date;}?>"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_department" required
                                                        ...
                                                        <option value="{{$dept->department_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_department == $dept->department_name) {echo 'selected';}}?>>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_designation" required
                                                        ...
                                                        <option value="{{$desg->designation_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_designation == $desg->designation_name) {echo 'selected';}}?>>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="date" name="emp_dob" id="emp_dob"
                                                        onchange="calculateDor()" data-msg-max="select date max today."
                                                        data-date-format="DD MMMM YYYY"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_dob;}?>"
                                                        class="form-control" required>
                                                </div>

                                                <div class="col-md-3">
                                                    <label>Date of Retirement </label>
                                                    <input type="text" name="emp_retirement_date"
                                                        id="emp_retirement_date" value="<?php if (request()->get('q') != '') {
    ...
    echo date_format($date_of_retire, 'd/m/Y');
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="date" name="emp_doj" id="emp_doj"
                                                        onchange="calculateDateOfIncrement()"
                                                        data-date-format="DD MMMM YYYY"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_doj;}?>"
                                                        class="form-control" required>
                                                </div>

                                                <div class="col-md-3">
                                                    <label>Confirmation Date</label>
                                                    <input type="date" name="emp_from_date"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_from_date;}?>"
                                                        class="form-control">
                                                </div>

                                                <div class="col-md-3">
                                                    <label>Next Increment Date </label>
                                                    <input type="date" name="emp_next_increment_date"
                                                        id="emp_next_increment_date"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_next_increament_date;}?>"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_eligible_promotion">
                                                        <option value="">Select</option>
                                                        <option value="Yes"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_eligible_promotion == 'Yes') {echo 'selected';}}?>>
                                                            Yes</option>
                                                        <option value="No"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_eligible_promotion == 'No') {echo 'selected';}}?>>
                                                            No</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_status" required>
                                                        ...
                                                        <option value="{{$emp->employee_type_name}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_status == $emp->employee_type_name) {echo 'selected';}}?>>
                                                            {{$emp->employee_type_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                    ...
                    <input type="hidden" name="emp_till_date" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_till_date;}?>" class="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_reporting_auth">
                                                        ...
                                                        <option value="{{$employeelist->emp_code}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_reporting_auth == $employeelist->emp_code) {echo 'selected';}}?>>
                                                            {{$employeelist->emp_fname}} {{$employeelist->emp_mname}}
                                                            {{$employeelist->emp_lname}} ({{$employeelist->emp_code}})
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" name="emp_lv_sanc_auth">
                                                        ...
                                                        <option value="{{$employee->emp_code}}"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_lv_sanc_auth == $employee->emp_code) {echo 'selected';}}?>>
                                                            {{$employee->emp_fname}} {{$employee->emp_mname}}
                                                            {{$employee->emp_lname}} ({{$employee->emp_code}})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <input type="hidden" name="old_image" class="form-control"
                                                    value="{{$employee_rs[0]->emp_image}}">

                                                <?php if (!empty($employee_rs[0]->emp_image)) {?>
                                                <img src="{{ asset($employee_rs[0]->emp_image) }}" height="auto"
                                                    width="80px">
                                                <?php }?>
                                            </div>

                                            <button class="btn btn-primary open1" type="button">Next <i
                                    ...
                                    <div id="sf2" class="frm" style="display: none;">
                                        <fieldset>
                                            ...
                                            <table border="1" class="table table-bordered table-responsove"
                                                style="border-collapse:collapse;overflow-x:scroll;">
                                                <thead>
                                                    <tr>
                                                        <th>Sl.No.</th>
                                                        <th>Qualification</th>
...
?> value='{{ $educ->id }}'>{{ $educ->education }}</option>
                                                        ...
                                                        <td><input type="text" name="discipline[]"
                                                                value="{{ $edu->discipline}}" class="form-control"></td>
                                                        <td><input type="text" name="institute_name[]"
                                                                value="{{ $edu->institute_name}}" class="form-control">
                                                        </td>
                                                        <td><input type="text" name="university[]"
                                                                value="{{ $edu->university}}" class="form-control"></td>
                                                        <td><input type="text" name="year_of_passing[]"
                                                                value="{{ $edu->year_of_passing}}" class="form-control">
                                                        </td>
                                                        <td><input type="text" name="percentage[]"
                                                                value="{{ $edu->percentage}}" class="form-control"></td>
                                                        <td><input type="text" name="grade[]" value="{{ $edu->grade}}"
                                                                class="form-control">

                                                            <!-- <input type="hidden" class="form-control" name="educations[]" value="{{ $edu->id}}"> -->
                                                        </td>

                                                        <td style="width:85px;"><button class="btn-success"
                                                                type="button" id="add<?php echo ($tr_id + 1); ?>"
                                                    ...
                                                    <tr class="itemslot" id="<?php echo $tr_id; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <select class="form-control" name="qualification[]">
                                                                ...
                                                                <option value='' selected>Select</option>
                                                                @foreach($education as $educ)
                                                                <option value='{{ $educ->id }}'>{{ $educ->education }}
                                                                </option>
                                                                @endforeach
                                                            </select>

                                                        </td>
                                                        <td><input type="text" name="discipline[]" value=""
                                                                class="form-control"></td>
                                                        <td><input type="text" name="institute_name[]" value=""
                                                                class="form-control"></td>
                                                        <td><input type="text" name="university[]" value=""
                                                                class="form-control"></td>
                                                        <td><input type="text" name="year_of_passing[]" value=""
                                                                class="form-control"></td>
                                                        <td><input type="text" name="percentage[]" value=""
                                                                class="form-control"></td>
					...
					<tr>
						...
						<td><input type="text" name="emp_other_rank" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_other_rank;}?>" class="form-control"></td>
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-warning back2" type="button"><i
                                                        class="ti-arrow-left"></i> Back</button>
                                                <button class="btn btn-primary open2" type="button">Next <i
                                        ...
                                        <fieldset>
                                            ...
                                            <table border="1" class="table table-bordered table-responsove"
                                                ...
                                                <tbody id="nomination">
                                                    <tr>
                                                        <td>1</td>
                                                        <td><input type="text" name="emp_nomination_name_one"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_name_one;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_relation_one"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_relationship_one;}?>"
                                                                class="form-control"></td>

                                                        <td><input type="date" name="emp_nomination_dob_one"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_dob_one;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_share_one"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_share_one;}?>"
                                                                class="form-control"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td><input type="text" name="emp_nomination_name_two"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_name_two;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_relation_two"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_relationship_two;}?>"
                                                                class="form-control"></td>

                                                        <td><input type="date" name="emp_nomination_dob_two"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->nominee_dob_two;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_share_two"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_share_two;}?>"
                                                                class="form-control"></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>3</td>
                                                        <td><input type="text" name="emp_nomination_name_three"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_name_three;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_relation_three"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_relation_three;}?>"
                                                                class="form-control"></td>

                                                        <td><input type="date" name="emp_nomination_dob_three"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_dob_three;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_share_three"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_share_three;}?>"
                                                                class="form-control"></td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>4</td>
                                                        <td><input type="text" name="emp_nomination_name_four"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_name_four;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_relation_four"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_relation_four;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="date" name="emp_nomination_dob_four"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_dob_four;}?>"
                                                                class="form-control"></td>
                                                        <td><input type="text" name="emp_nomination_share_four"
                                                                value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_nomination_share_four;}?>"
                                                                class="form-control"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="emp_blood_grp">
                                                        <option value="">Select</option>
                                                        <option value="A +"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "A +") {echo 'selected';}}?>>
                                                            A +</option>
                                                        <option value="A -"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "A -") {echo 'selected';}}?>>
                                                            A -</option>
                                                        <option value="B +"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "B +") {echo 'selected';}}?>>
                                                            B +</option>
                                                        <option value="B -"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "B -") {echo 'selected';}}?>>
                                                            B -</option>
                                                        <option value="AB +"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "AB +") {echo 'selected';}}?>>
                                                            AB +</option>
                                                        <option value="AB -"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "AB -") {echo 'selected';}}?>>
                                                            AB -</option>
                                                        <option value="O +"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "O +") {echo 'selected';}}?>>
                                                            O +</option>
                                                        <option value="O -"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_blood_group == "0 -") {echo 'selected';}}?>>
                                                            O -</option>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="emp_eye_sight_left"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_eye_sight_left;}?>"
                                                        class="form-control" id="">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Eye Sight (Right)</label>
                                                    <input type="text" name="emp_eye_sight_right"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_eye_sight_right;}?>"
                                                        class="form-control" id="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="emp_family_plan_status">
                                                        <option value="">Select</option>
                                                        <option value="yes"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_family_plan_status == "yes") {echo 'selected';}}?>>
                                                            yes</option>
                                                        <option value="no"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_family_plan_status == "no") {echo 'selected';}}?>>
                                                            No</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" name="emp_family_plan_date"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_family_plan_date;}?>"
                                                        class="form-control" id="">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Height (in cm)</label>
                                                    <input type="text" name="emp_height"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_height;}?>"
                                                        class="form-control" id="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="emp_weight"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_weight;}?>"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Identification Mark (1)</label><br>
                                                    <input type="text" name="emp_identification_mark_one"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_identification_mark_one;}?>"
                                                        class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Identification Mark (2)</label><br>
                                                    <input type="text" name="emp_identification_mark_two"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_identification_mark_two;}?>"
                                                        class="form-control">
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="form-control" name="emp_physical_status">
                                                        <option value="no"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_physical_status == "no") {echo 'selected';}}?>>
                                                            No</option>
                                                        <option value="yes"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_physical_status == "yes") {echo 'selected';}}?>>
                                                            Yes</option>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="emp_pr_street_no"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pr_street_no;}?>"
                                                        id="parmenent_street_name" class="form-control">
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Village</label>
                                                    <input id="parmenent_village" name="emp_per_village"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_per_village;}?>"
                                                        type="text" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>City</label>
                                                    <input type="text" name="emp_pr_city"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pr_city;}?>"
                                                        id="parmenent_city" class="form-control">
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="emp_per_post_office" name="emp_per_post_office"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_per_post_office;}?>"
                                                        type="text" class="form-control">
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Police Station</label>
                                                    <input type="text" id="emp_per_policestation"
                                                        name="emp_per_policestation"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_per_policestation;}?>"
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="parmenent_pincode" name="emp_pr_pincode"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pr_pincode;}?>"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="emp_per_dist" name="emp_per_dist"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_per_dist;}?>"
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="emp_pr_state" id="parmenent_state"
                                                        class="form-control" required>
                                                        <option value="" label="Select">Select</option>
                                                        <?php foreach ($states as $state) {?>
                                                        <option value="<?php echo $state->state_name; ?>"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_pr_state == $state->state_name) {echo 'selected';}}?>>
                                                ...
                                                <div class="col-md-4">
                                                    <label>Country</label>
                                                    <input id="parmenent_country" name="emp_pr_country"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pr_country;}?>"
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="parmenent_mobile" name="emp_pr_mobile"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pr_mobile;}?>"
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <!--			------------------------->
                                            ...
                                            <!-- present-address--------->
                                            <legend>Present Address <span><label class="checkbox-inline"><input
                                                            id="filladdress" type="checkbox" value="">( if Present
                                                        Address is same as permanent Address )</label></span></legend>
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    <label>Street No. and Name</label>
                                                    <input type="text" name="emp_ps_street_no" id="present_street_name"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_street_no;}?>"
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <label>Village</label>
                                                    <input id="emp_ps_village" name="emp_ps_village"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_village;}?>"
                                                        type="text" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>City</label>
                                                    <input type="text" name="emp_ps_city" id="present_city"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_city;}?>"
                                                        class="form-control">
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-4">
                                                    <label>Post Office</label>
                                                    <input id="emp_ps_post_office" name="emp_ps_post_office"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_post_office;}?>"
                                                        type="text" class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <label>Police Station</label>
                                                    <input type="text" id="emp_ps_policestation"
                                                        name="emp_ps_policestation"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_policestation;}?>"
                                                        class="form-control">
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Pin Code <span>(*)</span></label>
                                                    <input type="text" name="emp_ps_pincode" id="present_pincode"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_pincode;}?>"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <label>District</label>
                                                    <input type="text" id="emp_ps_dist" name="emp_ps_dist"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_dist;}?>"
                                                        class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="emp_ps_state" id="present_state" class="form-control"
                                                        ...
                                                        <?php foreach ($states as $state) {?>
                                                        <option value="<?php echo $state->state_name; ?>"
                                                            <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_ps_state == $state->state_name) {echo 'selected';}}?>>
                                                            <?php echo $state->state_name; ?></option>
                                                        <?php }?>
                                                    </select>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Country</label>
                                                    <input type="text" name="emp_ps_country" id="emp_ps_country"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_country;}?>"
                                                        class="form-control" readonly>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <label>Mobile No.</label>
                                                    <input type="text" name="emp_ps_mobile"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_mobile;}?>"
                                                        id="emp_ps_mobile" class="form-control">
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Phone No. </label>
                                                    <input type="text" name="emp_ps_phone"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_phone;}?>"
                                                        class="form-control">
                                                </div>

                                                <div class="col-md-4">
                                                    <label>Email </label>
                                                    <input type="email" name="emp_ps_email"
                                                        value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ps_email;}?>"
                                                        class="form-control">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-warning back3" type="button"><i
                                                        class="ti-arrow-left"></i> Back</button>
                                                <button class="btn btn-primary open3" type="button">Next <i
                                                        class="ti-arrow-right"></i></button>
                                    ...
                                    <div id="sf4" class="frm" style="display: none;">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <!-- <div class="col-md-3">
                                                ...
                                                <select data-placeholder="Choose a Groupe..." name="emp_group"
                                                    class="form-control" required>

                                                    <option value="" label="Select">Select</option>
                                                    @foreach($group_name as $group)
                                                    <option value="{{ $group->id}}"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_group_name == $group->id) {echo 'selected';}}?>>
    ...
    if ($employee_rs[0]->emp_pay_scale == $payscale->id) {echo 'selected';}
						...
						<?php }?>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" step="any" id="emp_basic_pay" name="emp_basic_pay"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->basic_pay;}?>"
                                                    class="form-control" required>
                                                <!-- <select class="form-control" name="emp_basic_pay" id="emp_basic_pay" required>
                   </select> -->

                                                <input type="hidden"  id="emp_apf_percent" name="emp_apf_percent" value="0">
                                            </div>
                                            <!-- <div class="col-md-3">
                                                <label>APF Deduction Rate (%) <span>(*)</span></label>
                                                <input type="number" step="any" id="emp_apf_percent"
                                                    name="emp_apf_percent"
                                                    value="<?php //if (request()->get('q') != '') {echo $employee_rs[0]->apf_percent;}?>"
                                                    class="form-control" required>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select data-placeholder="Choose a PF..." name="emp_pf_type"
                                                    class="form-control" required>
                                                    <option value="" label="Select">Select</option>
                                                    <option value="nps"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_type == 'nps') {echo 'selected';}}?>>
                                                        NPS</option>
                                                    <option value="gpf"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_type == 'gpf') {echo 'selected';}}?>>
                                                        PF</option>
                                                    <option value="cpf"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_type == 'cpf') {echo 'selected';}}?>>
                                                        CPF </option>
                                                    <option value="na"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_type == 'na') {echo 'selected';}}?>>
                                                        NA </option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Passport No.</label>
                                                <input type="text" name="emp_passport_no"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_passport_no;}?>"
                                                    class="form-control">
                                            </div>
			...
			<div class="row form-group"> -->
                                            ...
                                            <div class="col-md-3">
                                                <label>PF No. </label>
                                                <input type="text" name="emp_pf_no"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pf_no;}?>"
                                                    class="form-control">
                                            </div>
                                            <div class="col-md-3">
                                                <label>UAN No. </label>
                                                <input type="text" name="emp_uan_no"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_uan_no;}?>"
                                                    class="form-control">
                                            </div>

                                            <div class="col-md-3">
                                                <label>PAN No.</label>
                                                <input type="text" name="emp_pan_no"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pan_no;}?>"
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control" name="emp_bank_name" id="emp_bank_name"
                                                    required onchange="populateBranch()">
                                                    <option value="" label="Select">Select</option>
                                                    @if(isset($bank) && !empty($bank))
                                                    @foreach($bank as $key=>$value)
                                                    <option value="{{ $value->id}}"
                                                        <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_bank_name == $value->id) {echo 'selected';}}?>>
                                                        {{ $value->master_bank_name}}</option>
                                                    @endforeach
                                                    @endif
                                    ...
                                    <optionhidden  value="intra bank" <?php if (request()->get('q') != '') {if ($employee_rs[0]->emp_payment_type == 'intra bank') {echo 'selected';}}?>>Intra Bank</option>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" name="emp_ifsc_code"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_ifsc_code;}?>"
                                                    id="emp_ifsc_code" class="form-control" readonly required>
                                            </div>

                                            <div class="col-md-3">
                                                <label>Account No. <span>(*)</span></label>
                                                <input type="text" name="emp_account_no"
                                                    value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_account_no;}?>"
                                                    class="form-control" required>
                                            </div>

                                            <input type="hidden" name="emp_grade" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->grade_name;}?>">

                                            <input type="hidden" name="emp_pension" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pension;}?>">
                                            <input type="hidden" name="emp_pf_inactuals" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_pf_inactuals;}?>">
                                            <input type="hidden" name="emp_bonus" value="<?php if (request()->get('q') != '') {echo $employee_rs[0]->emp_bonus;}?>">
                                            ...
                                            <!-- <div class="col-md-3">
                                                ...
                                                <select class="form-control" name="emp_pension" id="emp_pension"
                                                    required>
                                                    <option value="">Select</option>
                                                    <option value="Y"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_pension == 'Y') {echo 'selected';}}?>>
                                                        Yes</option>
                                                    <option value="N"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_pension == 'N') {echo 'selected';}}?>>
                                                        No</option>
                                                </select>
                                            </div> -->
                                            <!-- <div class="col-md-3">
                                                <label>Basic above 15K @ 12% PF </label>
                                                <select class="form-control" name="emp_pf_inactuals"
                                                    id="emp_pf_inactuals" required>
                                                    <option value="">Select</option>
                                                    <option value="Y"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_inactuals == 'Y') {echo 'selected';}}?>>
                                                        Yes</option>
                                                    <option value="N"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_pf_inactuals == 'N') {echo 'selected';}}?>>
                                                        No</option>
                                                </select>
                                            </div> -->
                                            <!-- <div class="col-md-3">
                                                ...
                                                <select class="form-control" name="emp_bonus" id="emp_bonus" required>
                                                    <option value="">Select</option>
                                                    <option value="Y"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_bonus == 'Y') {echo 'selected';}}?>>
                                                        Yes</option>
                                                    <option value="N"
                                                        <?php //if (request()->get('q') != '') {if ($employee_rs[0]->emp_bonus == 'N') {echo 'selected';}}?>>
                                                        No</option>
                                                </select>
                                            </div> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-warning back4" type="button"><i
                                                    class="ti-arrow-left"></i> Back</button>
                                            <button class="btn btn-primary open4" type="button">Next <i
                                                    class="ti-arrow-right"></i></button>
                                            <img src="spinner.gif" alt="" id="loader" style="display: none">
                                        </div>
                                        <!------------------------------------>
...
if ($emp_pay_st->tds != '') {
    $arr_name_deduct[] = 'tds';
    $arr_value_deduct['tds'] = $emp_pay_st->tds;
    $arr_type_deduct['tds_type'] = $emp_pay_st->tds_type;
                                                    ...
                                                    <tbody id="marksheetearn">
                                                        ...
                                                        <tr class="itemslotpayearn" id="<?php echo $tr_id; ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <select class="form-control earninigcls"
                                                                    name="name_earn[]"
                                                                    id="name_earn<?php echo $tr_id; ?>"
                                                                    onchange="checkearntype(this.value,<?php echo $tr_id; ?>);">
                                                                    ...
                                                                    <option value='{{$name}}' @if($name==$valearn)
                                                                        selected @endif>{{ $value->head_name }}</option>
                                                                    @endif
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td>
                                                                <select class="form-control" name="head_type[]"
                                                                    id="head_type<?php echo $tr_id; ?>"
                                                                    onchange="checkearnvalue(this.value,<?php echo $tr_id; ?>);">

                                                                    <option value='' selected>Select</option>
                                                                    <option value='F' @if(
                                                                        $arr_type[$valearn.'_type']=='F' ) selected
                                                                        @endif>Fixed</option>
                                                                    <option value='V' @if(
                                                                        $arr_type[$valearn.'_type']=='V' ) selected
                                                                        @endif>Variable</option>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" name="value[]" @if(
                                                                    $arr_type[$valearn.'_type']=='F' ) readonly @endif
                                                                    id="value<?php echo $tr_id; ?>"
                                                                    value="{{$arr_value[$valearn]}}"
                                                                    class="form-control"></td>

                                                            <td>
                                                                @if(($tr_id+1)==count($arr_name))
                                                                <button class="btn-success" type="button"
                                                                    id="addearn<?php echo ($tr_id + 1); ?>"
                                                                    onClick="addnewrowearn(<?php echo ($tr_id + 1); ?>)"
                                                                    data-id="earn<?php echo ($tr_id + 1); ?>"> <i
                                                                        class="ti-plus"></i> </button>
                                                                @endif
                                                                <button class="btn-danger deleteButtonearnedit"
                                                                    style="background-color:#E70B0E; border-color:#E70B0E;"
                                                                    type="button" id="delearnedit<?php echo $tr_id; ?>"
                                                                    onClick="delRowearnedit(<?php echo $tr_id; ?>)"> <i
                                                        ...
                                                        <tr class="itemslotpayearn" id="<?php echo $tr_id; ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <select class="form-control earninigcls"
                                                                    ...
                                                                    @endphp
                                                                    @if($value->head_type == 'earning')
                                                                    <option value='{{$name}}'>{{ $value->head_name }}
                                                                    </option>
                                                                    @endif
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td><select class="form-control" name="head_type[]"
                                                                    id="head_type<?php echo $tr_id; ?>"
                                                                    onchange="checkearnvalue(this.value,<?php echo $tr_id; ?>);">
                                                    ...
                                                    <tbody id="marksheetdeduct">
                                                        ...
                                                        <tr class="itemslotpaydeduct" id="<?php echo $tr_id; ?>">
                                                            ...
                                                            <td>
                                                                ...
                                                                <select class="form-control deductcls"
                                                                    name="name_deduct[]"
                                                                    id="name_deduct<?php echo $tr_id; ?>"
                                                                    onchange="checkdeducttype(this.value,<?php echo $tr_id; ?>);">
                                                                    ...
                                                                    <option value='{{$name}}' @if($name==$valdeduct)
                                                                        selected @endif>{{ $value->head_name }}</option>
                                                                    @endif
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <td><select class="form-control " name="head_typededuct[]"
                                                                    id="head_typededuct<?php echo $tr_id; ?>"
                                                                    onchange="checkdeductvalue(this.value,<?php echo $tr_id; ?>);">

                                                                    <option value='' selected>Select</option>
                                                                    <option value='F' @if(
                                                                        $arr_type_deduct[$valdeduct.'_type']=='F' )
                                                                        selected @endif>Fixed</option>
                                                                    <option value='V' @if(
                                                                        $arr_type_deduct[$valdeduct.'_type']=='V' )
                                                                        selected @endif>Variable</option>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" name="valuededuct[]"
                                                                    value="{{$arr_value_deduct[$valdeduct]}}" @if(
                                                                    $arr_type_deduct[$valdeduct.'_type']=='F' ) readonly
                                                                    @endif id="valuededuct<?php echo $tr_id; ?>"
                                                                    class="form-control"></td>

                                                            <td>
                                                                @if(($tr_id+1)==count($arr_name_deduct))
                                                                <button class="btn-success" type="button"
                                                                    id="adddeduct<?php echo ($tr_id + 1); ?>"
                                                                    onClick="addnewrowdeduct(<?php echo ($tr_id + 1); ?>)"
                                                                    data-id="deduct<?php echo ($tr_id + 1); ?>"> <i
                                                                        class="ti-plus"></i> </button>
                                                                @endif
                                                                <button class="btn-danger deleteButtondeductedit"
                                                                    style="background-color:#E70B0E; border-color:#E70B0E;"
                                                                    type="button"
                                                                    id="deldeductedit<?php echo $tr_id; ?>"
                                                                    onClick="delRowdeductedit(<?php echo $tr_id; ?>)">
			...
			<label class="container1">Others
			  ...
			  <span class="checkmark"></span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-warning back5" type="button"><i
                                                    class="ti-arrow-left"></i> Back</button>
                                            <button class="btn btn-primary" type="button"
                                                onclick="checkearninghead();">Submit <i
                                                    class="ti-arrow-right"></i></button>
                                            <img src="spinner.gif" alt="" id="loader" style="display: none">
                                        </div>
                                    </div>
...
function calculateDor() {
    ...
    if (dateOfBirth.getDate() == 1 && sixty_years_ago.getMonth() == 0) {
        ...
        var lastdate = new Date(sixty_years_ago.getFullYear(), (sixty_years_ago.getMonth() + 1), 0).getDate();
        var lastDayWithSlashes = lastdate + '/' + (sixty_years_ago.getMonth() + 1) + '/' + sixty_years_ago
            .getFullYear();
    }
        ...
        success: function(response) {
            if (response.length > 0) {
                ...
                for (var i = 0; i < response.length; i++) {
                    option += '<option value="' + response[i].pay_scale_basic + '">' + response[i]
                        .pay_scale_basic + '</option>';
                }
...
$(document).ready(function() {
    ...
    $('#addnomination').click(function() {
        ...
        i++;
        $('#nomination').append('<tr id="rownominee' + i + '"><td>' + i +
            '</td><td><input type="text" name="nomination_name[]" class="form-control"></td><td><input type="text" name="nomination_relation[]" class="form-control"></td> <td><input type="text" name="nomination_age[]" class="form-control"></td><td><button type="button" id="' +
            i +
            '" class="btn btn-default pls btn_remove_nominee"><i class="fa fa-minus"></i></button></td></tr>'
        );
