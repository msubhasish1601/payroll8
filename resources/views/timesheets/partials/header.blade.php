        ...
        <div class="header-menu">
            ...
            <div class="user-area dropdown float-right">
                <a style="display: block;overflow: hidden;float:left;padding: 20px 15px 0 0;" class="home"
                    href="{{url('dashboard')}}"><img style="width: 26px;
    margin-top: 76px;" src="{{ asset('images/home.png') }}" alt="Logo"></a>
                <a title="HCM Dashboard" style="display: block;overflow: hidden;float:left;padding: 59px 15px 0 0;"
                ...
                <a title="Logout" style="display: block;overflow: hidden;float:left;padding: 25px 15px 0 0;"
                    class="home" href="{{url('logout')}}"><img src="{{ asset('img/login.png') }}" alt=" " style="margin-top: 66px;
    width: 30px;
}"></a>
