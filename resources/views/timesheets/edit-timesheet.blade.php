                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="timesheet_date"
                                            id="timesheet_date" value="{{ date('Y-m-d',strtotime($Timesheet->sheet_date)) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        $totHrs=0;
                                        $totMins=0;
                                        if(isset($Timesheet->total_hours_locked) && $Timesheet->total_hours_locked!=""){
                                            $totArr=explode('.',$Timesheet->total_hours_locked);
                                            $totHrs=$totArr[0]??'0';
                                            $totMins=$totArr[1]??'0';
                                        }
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive" id="divTaskList">
                                        <table class="table table-striped table-bordered" id="tblTaskList">
                                            ...
                                            <tbody>
                                                @if(count($timesheetDatails)>0)
                                                @foreach($timesheetDatails as $record)
                                                <tr>
                                                    ...
                                                    <a href="javascript:void(0);" class="delete"
                                                            onclick="removeFromList({{ $record->id }});"><i
                                    ...
                                    <div class="row" id="divTaskListSubmit" @if(count($timesheetDatails)>0) style="display:block;" @else style="display:none;" @endif>
                                        <div class="col-md-12">
                                            <div class="form-group">
            ...
            success: function(response) {
                ...
                $(function() {
                    ...
                    for (var i = 0; i < json.length; i++) {
                        ...
                        content +=
                            '<td style="text-align:center;"><a href="javascript:void(0);" class="delete" onclick="removeFromList(' +
                            json[i].id + ');"><i class="fa fa-trash text-red"></i></a></td>';
                        content += '</tr>';
                    }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $(function() {
                    ...
                    content); // **better. give the table a ID, and replace**
                    resetAddToListForm();
                });
